...
export default function Contact() {
  ...
  <div className="contain w-[800px] px-5 py-24 mx-auto border-gray-300">
    ...
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
       ...
       <Link href={'https://www.linkedin.com/in/kavita-luhana-0a31842ab/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3Btxl9VcSbQ0ChtnXRGhnisQ%3D%3D'}>
        <BsLinkedin className='text-[30px] '/></Link> 
       <Link href={'https://github.com/Kavita-LachmanDas'}> <BsGithub className='text-[30px]  '/> </Link> </div>
        </div>
      </div>
    </div>
  </div>
